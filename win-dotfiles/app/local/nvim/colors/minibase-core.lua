...
-- Files: ======================================================================
vim.api.nvim_set_hl(0, "MiniFilesBorder", { fg = palette.base0B, bg = palette.base00, bold = true, italic = false })
vim.api.nvim_set_hl(0, "MiniFilesDirectory", { fg = palette.base0B, bold = true, italic = false })
...
vim.api.nvim_set_hl(0, "MiniFilesNormal", { link = "MiniFilesBorder" })
...
-- Picker: ====================================================================
vim.api.nvim_set_hl(0, "MiniPickBorder", { fg = palette.base0B, bg = palette.base00, bold = true, italic = false })
vim.api.nvim_set_hl(0, "MiniPickNormal", { fg = palette.base0B, bg = palette.base00, bold = true, italic = false })
vim.api.nvim_set_hl(0, "MiniPickMatchCurrent", { bg = palette.base01, bold = true, italic = false })
vim.api.nvim_set_hl(0, "MiniPickMatchMarked", { fg = palette.base09, bg = palette.base00, bold = true, italic = false })
