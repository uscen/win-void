...
vim.api.nvim_set_hl(0, "MiniFilesDirectory", { fg = palette.base04, bold = true, italic = false })
...
vim.api.nvim_set_hl(0, "MiniPickNormal", { fg = palette.base04, bg = palette.base00, bold = true, italic = false })
