...
local hlgroups = {
  ...
  FloatBorder                              = { bg = c_macroBg2, fg = c_macroGreen1 },
  FloatFooter                              = { bg = c_macroBg2, fg = c_macroBg5 },
  FloatTitle                               = { bg = c_macroBg2, fg = c_macroGreen1, bold = true },
  ...
  NormalFloat                              = { bg = c_macroBg2, fg = c_macroFg1 },
  ...
  StatusLine                               = { bg = c_macroBg1, fg = c_macroFg1 },
  ...
  MiniPickMatchCurrent                     = { bg = c_macroBg3 },
  MiniPickMatchMarked                      = { bg = c_macroBg2, fg = c_macroGreen0 },
  MiniPickPrompt                           = { bg = c_macroBg2, fg = c_macroGreen0 },
