...
vim.api.nvim_set_hl(0, 'CursorLine', { fg = gui00, bg = gui17, ctermbg = cterm01 })
...
vim.api.nvim_set_hl(0, 'FloatBorder', { fg = gui17, ctermfg = cterm09 })
...
vim.api.nvim_set_hl(0, 'MiniFilesCursorLine', { bg = "NONE", bold = true, italic = true })
vim.api.nvim_set_hl(0, 'MiniFilesDirectory', { fg = gui0A, bold = true, italic = true })
vim.api.nvim_set_hl(0, 'MiniFilesFile', { fg = gui0A, bold = true, italic = true })
...
-- Mini Pick
vim.api.nvim_set_hl(0, 'MiniPickNormal', { link = "MiniFilesFile" })
