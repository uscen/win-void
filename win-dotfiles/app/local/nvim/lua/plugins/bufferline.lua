...
return {
	{
		...
		opts = {
			...
			highlights = {
				fill = { bg = "#141617", fg = "#141617" },
				background = { bg = "#141617" },
				separator = { bg = "#141617", fg = "#141617" },
				separator_selected = { fg = "#141617" },
				separator_visible = { fg = "#141617" },
				close_button_visible = { bg = "#141617" },
				close_button = { bg = "#141617" },
				buffer_selected = { fg = "#89b482", bold = true, italic = false },
